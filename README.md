[![Latest version](https://img.shields.io/npm/v/@patrtorg/praesentium-sit.svg)](https://www.npmjs.com/package/@patrtorg/praesentium-sit)

# `@patrtorg/praesentium-sit`
...
```bash
npm install @patrtorg/praesentium-sit
```
...
```js
import { ClientRequestInterceptor } from '@patrtorg/praesentium-sit/ClientRequest'
...
```js
import { BatchInterceptor } from '@patrtorg/praesentium-sit'
import { ClientRequestInterceptor } from '@patrtorg/praesentium-sit/ClientRequest'
import { XMLHttpRequestInterceptor } from '@patrtorg/praesentium-sit/XMLHttpRequest'
...
```js
import { BatchInterceptor } from '@patrtorg/praesentium-sit'
import nodeInterceptors from '@patrtorg/praesentium-sit/presets/node'
...
```js
import { BatchInterceptor } from '@patrtorg/praesentium-sit'
import browserInterceptors from '@patrtorg/praesentium-sit/presets/browser'
...
```js
import { WebSocketInterceptor } from '@patrtorg/praesentium-sit/WebSocket'
...
```js
// child.js
import { RemoteHttpInterceptor } from '@patrtorg/praesentium-sit/RemoteHttpInterceptor'
import { ClientRequestInterceptor } from '@patrtorg/praesentium-sit/ClientRequest'
...
import { RemoteHttpResolver } from '@patrtorg/praesentium-sit/RemoteHttpInterceptor'
